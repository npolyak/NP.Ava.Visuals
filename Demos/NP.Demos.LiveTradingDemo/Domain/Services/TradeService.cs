...
public class TradeService : ITradeService, IDisposable
{
    ...
    public TradeService(TradeGenerator tradeGenerator, ISchedulerProvider schedulerProvider)
    {
        ...
        return ObservableChangeSet.Create<Trade, long>(cache =>
        {
            ...
            */
            ...
            var expirer = cache
                ...
                .Subscribe(x => Console.WriteLine($"{x.Count()} filled trades have been removed from memory"));
